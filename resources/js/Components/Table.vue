<template>
  ...
  <div class="flex overflow-x-auto mx-auto p-4">
      ...
      <tbody>
        <tr v-for="(entry, index) in entries" :key="index"
          ...
          <td class="flex justify-between items-center px-6 py-4">
            ...
            <img v-if="entry.thumbnailPath" class="h-auto max-w-xl rounded-lg shadow-xl dark:shadow-gray-800"
              :src="getFileUrl(entry.thumbnailPath)" alt="thumbnail">
          </td>
    ...
    <PopupModal :key="deleteRowId" text="Are you sure you want to delete this entity?"
      @submitModal="submitDeleteRowModal" @closeModal="closeDeleteRowModal">
    </PopupModal>
  </div>
</template>
